  ...
  return (
    <div className="min-h-screen bg-[#09090B] text-slate-100 flex flex-col font-sans">
      ...
      <div className="relative w-full aspect-[21/9] md:aspect-[24/7] lg:aspect-[21/5] overflow-hidden border-b border-white/[0.04]">
        ...
        <div className="absolute bottom-6 left-6 md:left-12 max-w-2xl pr-6 flex flex-col justify-end h-full">
          <Badge className="bg-[#E2B53E] text-black font-semibold uppercase tracking-wider mb-2 self-start hover:bg-[#E2B53E]/90">
          ...
          <p className="text-slate-300 text-sm md:text-base mt-2 max-w-xl drop-shadow hidden sm:block">
              ...
              <div className="glass-card p-6 md:p-8 border border-white/[0.04] flex-1 flex flex-col gap-6">
                ...
                <div className="flex justify-between items-center border-t border-white/[0.06] pt-6 mt-4">
                  ...
                  <Button
                    ...
                    className="bg-[#E2B53E] text-black hover:bg-[#E2B53E]/90 font-semibold"
                  >
                    Next Day
            ...
            <Card className="glass-card border border-white/[0.04] bg-zinc-950/20 p-6 flex flex-col justify-between">
              ...
              <div className="mt-6 border-t border-white/[0.04] pt-4 flex flex-wrap gap-3">
                <Button 
                  ...
                  className="bg-[#E2B53E] text-black hover:bg-[#E2B53E]/90 text-xs font-semibold"
                >
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button 
                  ...
                  className="bg-[#E2B53E] text-black hover:bg-[#E2B53E]/90 text-xs font-semibold gap-1"
                >
          ...
          <div className="flex-1 flex flex-col lg:flex-row gap-6">
            ...
            <Card className="glass-card border border-white/[0.04] bg-zinc-950/20 p-6 w-full lg:w-[400px] shrink-0">
              ...
              <form onSubmit={handleDownloadPitch} className="space-y-4 text-xs">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-[#E2B53E] text-black hover:bg-[#E2B53E]/90 font-semibold py-2.5 text-xs flex items-center justify-center gap-2 mt-6 shadow-md"
                >
          ...
          <div className="bg-[#121214] border border-white/[0.06] rounded-xl p-6 w-full max-w-md shadow-2xl">
            ...
            <form onSubmit={handleAddProspect} className="space-y-4 text-xs">
              ...
              <div className="flex justify-end gap-2 pt-4">
                ...
                <Button type="submit" className="bg-[#E2B53E] text-black hover:bg-[#E2B53E]/90 font-semibold">Save Prospect</Button>
              </div>
            </form>
          </div>
        </div>
          ...
          <div className="bg-[#121214] border border-white/[0.06] rounded-xl p-6 w-full max-w-md shadow-2xl">
            ...
            <form onSubmit={handleAddTask} className="space-y-4 text-xs">
              ...
              <div className="flex justify-end gap-2 pt-4">
                ...
                <Button type="submit" className="bg-[#E2B53E] text-black hover:bg-[#E2B53E]/90 font-semibold">Create Task</Button>
              </div>
            </form>
          </div>
        </div>
